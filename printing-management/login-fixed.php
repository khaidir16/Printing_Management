...
<head>
    ...
    <title>Login - PrintPro Management (FIXED)</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="login-container">
        <div class="login-header">
            <div class="login-header-content">
                ...
                <p><small>FIXED VERSION</small></p>
            </div>
        </div>
        
        <div class="login-form">
            <div class="debug-info">
                <h4>✅ Status: Authentication WORKING</h4>
                <p>Diagnostic test berhasil - login sudah diperbaiki!</p>
            </div>
            ...
            <div class="demo-credentials">
                ...
                <p><strong>Manager:</strong> manager1 / admin123</p>
            </div>
            ...
            <form id="loginForm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="username" name="username" required 
                           placeholder="Masukkan username atau email" value="admin">
                </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            // Send login request with enhanced error handling
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showAlert(data.error || 'Login gagal - response tidak valid', 'error');
                }
            })
            .catch(error => {
        ...
        fetch('api/auth.php?action=check')
            ...
            .then(data => {
                if (data.logged_in) {
                    showAlert('Sudah login, mengalihkan ke dashboard...', 'success');
                    setTimeout(() => {
                        window.location.href = 'index.php';
                    }, 1000);
                }
